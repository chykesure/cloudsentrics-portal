      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <ul>
              <li><b>Previous Tier:</b> ${previousTier} (${previousStorage})</li>
          ...
          <tr>
            <td style="padding:30px 40px;">
              ...
              <p style="font-size:15px;margin-bottom:25px;">
                A new <strong>storage upgrade request</strong> has been submitted and is awaiting your review.
              </p>

              <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin-bottom:25px;">
                <tr><td style="padding:8px 0;"><strong>Organization Name:</strong></td><td>${companyName}</td></tr>
                <tr><td style="padding:8px 0;"><strong>Current Plan:</strong></td><td>${previousTier} (${previousStorage})</td></tr>
                <tr><td style="padding:8px 0;"><strong>Requested Plan:</strong></td><td>${newTier} (${newStorage})</td></tr>
                <tr><td style="padding:8px 0;"><strong>Date Submitted:</strong></td><td>${new Date().toLocaleString()}</td></tr>
              </table>

              <div style="text-align:center;margin-top:30px;">
                <a href="https://admin.cloudsentrics.org/"
              ...
              <p style="font-size:14px;color:#555;margin-top:30px;line-height:1.6;">
                Please log in to the <a href="https://admin.cloudsentrics.org/" style="color:#032352;font-weight:500;">Admin Portal</a>
