...
const fetchAllJiraIssues = async () => {
    ...
    // 🔍 Check environment variables before making Jira API calls
    console.log("🔍 Checking Jira ENV:", {
        JIRA_PROJECT_KEY,
        JIRA_BASE_URL,
        JIRA_EMAIL: process.env.JIRA_EMAIL ? "✅ Loaded" : "❌ Missing",
        JIRA_API_TOKEN: process.env.JIRA_API_TOKEN ? "✅ Loaded" : "❌ Missing",
    });
    ...
    try {
        ...
        console.error("❌ Jira API fetch error:", {
...
exports.getAdminDashboard = async (req, res) => {
    try {
        console.log("📩 Incoming admin dashboard request"); // 👈 Add this
