...
router.post("/", async (req, res) => {
  try {
    ...
    const aliases = awsSetup?.aliases || {};

    // ✅ Validate input
    if (!companyInfo || !awsSetup) {
      return res
        .status(400)
        .json({ error: "Missing required fields: companyInfo or awsSetup" });
    }
  ...
  <p style="font-size: 14px; color: #666; margin-top: 10px;">
    This password is auto-generated. You will be required to change it on your first login.
          ...
          <p style="font-size: 12px; color: #999; text-align: center;">
            This email was automatically generated by <strong>CloudSentrics.org</strong>. Keep your Customer ID safe for future reference.
          </p>
        </div>
      `,
    };
