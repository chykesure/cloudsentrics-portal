      ...
      <div className="flex-1 space-y-6 p-4">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#032352] text-white rounded hover:bg-blue-800"
          >
                    ...
                    <td className="py-2 px-4">
                      <button
                        ...
                        className={`p-1 rounded ${
                          s.active ? "bg-green-100 hover:bg-green-200" : "bg-red-100 hover:bg-red-200"
                        }`}
                      >
