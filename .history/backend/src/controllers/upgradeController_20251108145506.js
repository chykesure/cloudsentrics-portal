  ...
  try {
    ...
    if (email) {
      ...
      `,
        ...
        await transporter.sendMail({
          from: `"New Upgrade Request" <${email}>`,
          to: "info@cloudsentrics.org",  
      ...
      <tr>
        <td align="center">
          <table role="presentation" cellpadding="0" cellspacing="0" width="600"
            style="background:#ffffff;border-radius:10px;overflow:hidden;box-shadow:0 4px 15px rgba(0,0,0,0.08);">
            ...
            <tr>
              <td style="padding:30px 40px;">
                ...
                <p style="font-size:15px;margin-bottom:25px;">
                  Please log in to the Admin Portal to review this request.<br />
                  Once reviewed, select either Approve or Reject to complete the action.<br /><br />
                ...
                <p style="font-size:14px;color:#555;margin-top:30px;line-height:1.6;">
                  ...
                  <a href="https://onboardingportal.cloudsentrics.org/admin/login" style="color:#032352;font-weight:500;">
                    Admin Portal
                  </a> 
                  to review and take action. Once reviewed, you can 
                  <strong>Approve</strong> or <strong>Reject</strong> the request.
                </p>
              </td>
            </tr>
