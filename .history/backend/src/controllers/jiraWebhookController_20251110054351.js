...
const Onboarding = require("../models/Onboarding"); // adjust path to where your model is
      ...
      if (reporterEmail) {
        const onboardingRecord = await Onboarding.findOne({
          $or: [
            ...
            { "companyInfo.primaryEmail": reporterEmail },
            { "companyInfo.secondaryEmail": reporterEmail }
          ]
