...
`;
    ...
    let recipientEmail = email; // fallback to form email if not found

    if (onboardingRecord?.companyInfo?.companyEmail) {
      recipientEmail = onboardingRecord.companyInfo.companyEmail;
    }
