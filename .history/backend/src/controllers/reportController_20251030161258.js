  ...
  try {
    ...
    const descriptionADF = {
      ...
      content: [
        ...
        {
          type: "paragraph",
          content: [{ type: "text", text: `Phone: ${phone || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Company: ${company || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Account ID: ${accountId}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Bucket Name: ${bucketName || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Title: ${title || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Description: ${description || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Date/Time: ${date || "N/A"} / ${time || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Category: ${category || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Other Category: ${otherCategoryDesc || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Steps Taken: ${steps || "N/A"}` }],
        },
        {
          type: "paragraph",
          content: [{ type: "text", text: `Confirmed: ${confirm ? "Yes" : "No"}` }],
        },
      ],
    };
