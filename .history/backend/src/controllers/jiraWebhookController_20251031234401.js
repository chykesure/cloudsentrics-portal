...
• {{InformationNeeded}}
Once we receive this information, we’ll resume work immediately and keep you updated on progress.
...
www.cloudsentrics.org`,
      ...
      Done: {
        ...
        body: `Dear {{ClientName}},
We’re pleased to inform you that your request (Ticket ID: {{ticket_id}}) has been successfully provisioned.
Please review the outcome and let us know if your request has been fulfilled as expected. If you need any additional support or would like to make another request, simply reply to this email and our team will be happy to assist you.
...
Please review the outcome and let us know if everything is working as expected. If you need any further assistance, simply reply to this email and we’ll be glad to help.
Thank you for choosing Cloud Sentrics Limited, we appreciate your trust in our services.
Best regards,
