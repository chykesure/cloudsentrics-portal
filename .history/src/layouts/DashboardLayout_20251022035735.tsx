  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      ...
      try {
        ...
        const fullUser = {
          ...profile,
          companyName: companyData?.company?.companyName?.trim() || parsedUser.companyEmail || "Unknown Company",
        };
        const fullUser = {
          ...profile,
          companyName: companyData?.companyInfo?.companyName?.trim() || parsedUser.companyEmail || "Unknown Company",
        };
