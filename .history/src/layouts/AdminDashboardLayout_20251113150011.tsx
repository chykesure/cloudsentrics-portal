...
import { LogOut, LayoutDashboard, User, Menu, X, Bell, UserPlus } from "lucide-react";
...
const AdminDashboardLayout = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: UserPlus, // 👥 Represents team/staff
    },
    {
      ...
      <nav className="flex-1 px-3 py-6 space-y-2">
        {navItems
          .filter(
            ({ label }) =>
              !(admin?.role === "readonly" &&
                ["Staff Management", "Customer Directory", "Upgrade Request(s)"].includes(label))
          )
