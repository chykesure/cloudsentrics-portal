...
const DashboardLayout = () => {
    ...
    const handleLogout = () => {
        ...
        setTimeout(() => {
            setLoading(false);
            navigate("/");
        }, 2000); // simulate loading before redirect
    };
    ...
    return (
        <div className="flex h-screen bg-gray-100 text-gray-800">
            ...
            <div className="flex-1 flex flex-col">
                {/* Top Navbar */}
                <header className="h-16 bg-white shadow flex items-center justify-start px-6">
                    ...
                    {/* Optional Page Title */}
                    <h2 className="ml-8 text-xl font-semibold text-gray-700">Dashboard</h2>
                </header>
