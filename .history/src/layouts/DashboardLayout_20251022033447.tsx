...
import { LogOut, LayoutDashboard, FileText, AlertTriangle, User, Menu, X } from "lucide-react";
...
const DashboardLayout = () => {
  ...
  const [profileImage, setProfileImage] = useState<string | null>(localStorage.getItem("avatar") || null);
  ...
  useEffect(() => {
    ...
    const fetchCompanyDetails = async () => {
      if (!parsedUser.companyEmail) return;
      ...
      try {
        ...
        setUser((prev) => prev ? { ...prev, companyName } : null);
      } catch (err) {
