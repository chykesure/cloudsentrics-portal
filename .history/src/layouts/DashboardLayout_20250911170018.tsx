...
const DashboardLayout = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-50 text-gray-800">
            {/* Sidebar */}
            <aside className="w-64 bg-[#032352] text-white flex flex-col shadow-xl">
                {/* Logo */}
                <div className="p-6 flex flex-col items-center justify-center border-b border-blue-900">
                    <img src={logo} alt="Logo" className="h-34 mb-2" />
                    <h1 className="text-lg font-semibold">CloudSentric</h1>
                </div>
            ...
            <div className="flex-1 flex flex-col">
                {/* Top Navbar */}
                <header className="h-16 bg-[#032352] shadow-md flex items-center justify-between px-6 text-white">
                    {/* Left: Page Title */}
