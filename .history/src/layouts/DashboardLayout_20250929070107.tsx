  ...
  const Sidebar = () => (
    <div className="w-64 bg-[#032352] text-white flex flex-col shadow-xl h-full">
      <div className="p-6 flex flex-col items-center justify-center border-b border-blue-900">
        ...
        {user && <span className="text-white font-semibold text-sm sm:text-base">{user.companyEmail}</span>}
      </div>
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-800">
      ...
      <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center space-x-4 sm:space-x-6">
            ...
            <div className="relative">
              <button onClick={() => setDropdownOpen(!dropdownOpen)} className="flex items-center space-x-2 focus:outline-none">
                <img src={defaultAvatar} alt="User" className="h-8 w-8 sm:h-9 sm:w-9 rounded-full border-2 border-white" />
                <span className="font-medium hidden sm:inline">{user?.companyEmail || "Guest"}</span>
              </button>

              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg py-2 z-50 text-gray-700">
                  <NavLink to="/dashboard/profile" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-gray-100">
        ...
        {/* Main Content */}
        <main id="main-scroll" className="flex-1 px-0 sm:px-2 md:px-4 lg:px-12 py-4 overflow-y-auto bg-white w-full">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-[9998]">
          <div className="bg-white rounded-2xl shadow-lg p-6 w-80 sm:w-96 text-center">
            ...
            <div className="mt-6 flex justify-center space-x-4">
              <button onClick={() => setShowLogoutModal(false)} className="px-4 py-2 rounded-lg border border-gray-300 text-gray-600 hover:bg-gray-100">
                Cancel
              </button>
