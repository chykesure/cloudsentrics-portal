...
const OnboardingForm3 = () => {
  ...
  const handleSubmit = () => {
    ...
    const onboardingData: OnboardingData = {
      companyInfo: {
        companyName: formDataStep1.companyName,
        companyEmail: formDataStep1.companyEmail,
        primaryContact: {
          name: formDataStep1.primaryName,
          phone: formDataStep1.primaryPhone,
          email: formDataStep1.primaryEmail,
        },
        secondaryContact: {
          name: formDataStep1.secondaryName,
          phone: formDataStep1.secondaryPhone,
          email: formDataStep1.secondaryEmail,
        },
      },
      awsSetup: {
      ...
      userId: userId, // optional if you have a logged-in user
    };
  };
