...
import Footer from "./Footer"; // Ensure Footer.tsx is exported
...
const StaffManagement = () => {
  ...
  useEffect(() => {
    const role = localStorage.getItem("adminRole"); // "Super-Admin" or "Admin"
  ...
  const openEditModal = (s: Staff) => {
    setEditingStaff(s);
    setFormData({ email: s.email, role: s.role, password: "" });
    setShowModal(true);
  };
      ...
      <div className="flex-1 space-y-6 p-4">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            disabled={currentUserRole !== "Super-Admin"} // Disable if not Super-Admin
                  ...
                  >
                    ...
                    <td className="py-2 px-4">
                      <button
                        ...
                        className={`p-1 rounded ${s.active ? "bg-green-100 hover:bg-green-200" : "bg-red-100 hover:bg-red-200"
                          }`}
                      >
                        {s.active ? <ToggleRight className="w-5 h-5 text-green-600" /> : <ToggleLeft className="w-5 h-5 text-red-600" />}
                      </button>
                    </td>
  ...
  <button
    ...
    className={`p-1 rounded hover:bg-gray-200 ${currentUserRole !== "Super-Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
    disabled={currentUserRole !== "Super-Admin"}
  >
  ...
  <button
    ...
    className={`p-1 rounded hover:bg-red-200 ${currentUserRole !== "Super-Admin" ? "opacity-50 cursor-not-allowed" : ""}`}
    disabled={currentUserRole !== "Super-Admin"}
  >
