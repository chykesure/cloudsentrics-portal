...
const AdminDashboard = () => {
  ...
  // ✅ Updated stats to include "Blocked"
  const stats = [
    ...
    { label: "Blocked", value: dashboardData.blocked, icon: AlertTriangle },
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs sm:text-sm md:text-base mt-1 opacity-80">{item.label}</p>
              </div>
            </motion.div>
          );
        })}
