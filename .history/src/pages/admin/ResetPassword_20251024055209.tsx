...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      //const res = await fetch(`https://api.onboardingportal.cloudsentrics.org/api/staff/auth/reset-password/${token}`, {
      const res = await fetch(`https://api.onboardingportal.cloudsentrics.org/api/admin/reset-password/${token}`, {
