                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                    ...
                    >
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold text-gray-800">{editingStaff ? "Edit Staff" : "Add Staff"}</h3>
                            <button onClick={() => setShowModal(false)} className="p-1 rounded hover:bg-gray-200"><X className="w-5 h-5" /></button>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-3 py-2 border rounded focus:ring-blue-600 focus:border-blue-600"
                                />
                            </div>
