...
const StaffManagement = () => {
  ...
  const handleDelete = async (id: string) => {
    if (currentUserRole !== "admin") {
      toast.error("Only admin can delete staff.");
      return;
    }
    ...
    if (result.isConfirmed) {
      try {
        ...
        // Update state to remove deleted staff
              ...
              <tbody>
                {staff.length ? (
                  staff.map((s, idx) => {
                    ...
                    // ✅ compute proper active state per staff row
                    const isActive =
                      s.role === "admin" || s.email === currentAdminEmail
                        ? true
                        : !!s.active;
