...
const AdminProfilePage = () => {
  ...
  return (
    <div className="min-h-[80vh] w-full bg-gradient-to-b from-gray-100 to-gray-50 pb-16 relative">
      ...
      {/* Cards overlaying banner */}
      <div className="max-w-5xl mx-auto -mt-28 sm:-mt-32 px-4 sm:px-8 flex flex-col md:flex-row gap-8 justify-center items-start relative z-10">
        {/* Profile Card */}
        <motion.div
