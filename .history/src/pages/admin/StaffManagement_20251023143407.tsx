              ...
              <tbody>
                {staff.length ? (
                  staff.map((s, idx) => {
                    ...
                    const activeStatus = isAdminRow ? true : s.active;
                      ...
                      >
                        ...
                        <td className="py-2 px-4">
                          <button
                            ...
                            disabled={currentUserRole !== "admin" && !isAdminRow}
                            className={`p-1 rounded ${activeStatus
                              ? "bg-green-100 hover:bg-green-200"
                              : "bg-red-100 hover:bg-red-200"
                              } ${currentUserRole !== "admin" && !isAdminRow
