...
import Footer from "./Footer"; // Make sure your Footer component is exported from Footer.tsx
    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className="flex-1 space-y-6 p-4">
        <div className="flex justify-between items-center">
          ...
          <button onClick={openAddModal} className="flex items-center gap-2 px-4 py-2 bg-[#032352] text-white rounded hover:bg-blue-800">
