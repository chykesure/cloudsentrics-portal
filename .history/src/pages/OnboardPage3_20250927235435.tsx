...
interface OnboardingForm3Props {
  ...
  formDataStep2: OnboardingData["awsSetup"];
}

const OnboardingForm3: React.FC<OnboardingForm3Props> = ({ formDataStep1, formDataStep2 }) => {
  ...
  const handleSubmit = async () => {
    if (!agreements.agree || !agreements.acknowledge || !agreements.confirm) {
