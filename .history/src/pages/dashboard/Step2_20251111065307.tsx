...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  if (tierId === "custom") {
    ...
    if (!value) return; // cancelled or invalid
    customInput = value;
    ...
    finalTierInfo = {
      ...
      rank: currentTierInfo?.rank || 0, // treat as same rank
    };

    await Swal.fire({
      icon: "success",
      title: "Custom Tier Saved",
      text: `Your custom tier request for ${customInput.amount} ${customInput.unit} has been saved.`,
      confirmButtonColor: "#032352",
    });
  } else {
    // --- Normal Tier
  ...
  try {
    ...
    console.log("✅ Upgrade request submitted:", res.data);
