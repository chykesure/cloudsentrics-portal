...
const DashboardHome = () => {
  ...
  // Hardcoded stats
  const stats = [
    { title: "Forms Submitted", value: 5, color: "from-green-400 to-green-600", icon: FileText },
    { title: "Resources Viewed", value: 12, color: "from-purple-400 to-purple-600", icon: User },
    { title: "Notifications", value: 3, color: "from-yellow-400 to-yellow-600", icon: Bell },
  ];
