            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {issues.map((item, idx) => {
                        ...
                        // gradients for issues row
                        const issueGradients = [
                            "from-[#032352] to-blue-700",   // deep blue
                            "from-green-600 to-emerald-500", // green
                            "from-rose-600 to-orange-500"   // reddish-orange
                        ];
                        ...
                        return (
                            <motion.div
                                ...
                                transition={{ delay: idx * 0.2 }}
                                whileHover={{ scale: 1.04 }}
                                className={`bg-gradient-to-br ${issueGradients[idx]} p-10 min-h-[200px] rounded-2xl shadow-lg flex items-center gap-8 hover:shadow-2xl transition text-white`}
                            >
                                {/* Larger icon with translucent background */}
                                <div className="p-6 rounded-full bg-white/20 flex items-center justify-center">
                                ...
                                {/* Bigger number + label */}
                                <div>
                                    <h3 className="text-5xl font-extrabold">{count}</h3>
