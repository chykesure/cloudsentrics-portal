      ...
      >
        ...
        <div className="p-4 sm:p-6 bg-white shadow-md rounded-lg mb-8">
          ...
          {[
            ...
            { value: "EmailOTP", label: "Email + OTP", description: "Delivered via email and requires OTP on WhatsApp." },
            { value: "WhatsApp", label: "WhatsApp Only", description: "Delivered via WhatsApp." },
            { value: "WhatsAppEmail", label: "Both WhatsApp & Email", description: "Delivered via both channels." },
