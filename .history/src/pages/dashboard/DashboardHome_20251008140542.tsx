  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 p-6 sm:p-10 space-y-10">
      ...
      <motion.div 
        ...
        className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative"
      >
        <div>
        ...
        {avatarUrl && (
          <img
            src={avatarUrl}
            alt="User Avatar"
            className="w-48 h-48 object-cover rounded-full hidden md:block border-4 border-white relative z-10"
          />
        )}
      </motion.div>
