      ...
      >
        ...
        {fileSharing === "Yes" && (
          <div className="ml-2 sm:ml-4 space-y-4">
            {[
              { value: "Email", label: "Email Only: Delivered via email." },
              {
                value: "EmailOTP",
                label:
                  "Email + OTP: Delivered via email and requires OTP on WhatsApp.",
              },
              {
                value: "WhatsApp",
                label: "WhatsApp Only: Delivered via WhatsApp.",
              },
              {
                value: "WhatsAppEmail",
                label: "Both WhatsApp & Email delivery.",
              },
            ].map(({ value, label }) => {
              // Split label into bold title and normal description
