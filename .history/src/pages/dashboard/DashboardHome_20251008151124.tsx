...
const DashboardHome = () => {
  ...
  const announcements: Announcement[] = [
    ...
    {
      id: 2,
      title: "New Report Feature",
      message: "You can now track all your issue reports in one place. Try it out!",
      date: "2025-10-07",
    },
    {
      id: 3,
      title: "Request Updates",
      message: "Check your dashboard for updates on any requests you've submitted.",
      date: "2025-10-06",
    },
    {
      id: 4,
