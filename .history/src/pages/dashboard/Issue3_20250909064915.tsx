  ...
  return (
    ...
    >
      ...
      <p className="mb-6 text-gray-800 text-base leading-relaxed">
        ...
        quickly. Please provide as many details as possible to help us resolve
        your issue faster.
      </p>
      ...
      <div className="mt-10 flex gap-4">
        <button
          onClick={goBack}
          className="w-1/2 bg-gray-200 hover:bg-gray-300 text-gray-800 py-3 rounded-lg text-lg font-semibold"
        >
          Back
        </button>
        <button
          onClick={onSubmit}
          className="w-1/2 bg-[#032352] hover:bg-[#021a3d] text-white py-3 rounded-lg text-lg font-semibold"
        >
          Submit
        </button>
      </div>
