...
import { User, Settings, FileText, Bell, Star, StatCard } from "lucide-react";
...
// Reusable Components
// =======================
const StatCard = ({ title, Icon, color }: { title: string; Icon: any; color: string }) => (
  <motion.div
...
const QuickActionCard = ({ title, description, Icon }: QuickAction) => (
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
    whileHover={{ scale: 1.05 }}
...
const AnnouncementCard = ({ title, message }: Announcement) => (
  <motion.div
