...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-100">
        ...
        >
          ...
          <div className="mt-8 flex justify-end">
            <button
              ...
              className="px-6 py-2.5 bg-[#032352]/10 text-[#032352] rounded-lg shadow hover:bg-[#032352]/20 transition font-medium"
            >
              Change password
            </button>
          </div>
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-transaparent bg-opacity-50">
