                ...
                {Array.from(
                  ...
                  <div key={label} className="w-full">
                    ...
                    <div className="flex flex-col sm:flex-row w-full">
                      <span className="inline-flex items-center justify-center px-4 py-2 sm:py-0 rounded-t-md sm:rounded-l-md sm:rounded-t-none border border-b-0 sm:border-b border-gray-300 bg-gray-100 text-gray-600 text-sm sm:text-lg w-full sm:w-auto">
                        cloudsentrics-aws-
                      </span>
                      <input
                        type="text"
                        ...
                        className="flex-1 px-4 py-3 border border-gray-300 rounded-b-md sm:rounded-r-md text-sm sm:text-lg min-w-0"
                      />
                    </div>
                  </div>
                ))}
