...
const Issue3 = ({ goBack, onSubmit }: Issue3Props) => {
  ...
  return (
    ...
    >
      ...
      <div>
        <div className="bg-orange-50 py-3 px-4 uppercase text-blue-900 font-bold mb-6 text-lg">
          ADDITIONAL DETAILS
        </div>
        ...
        <div className="mb-8">
          ...
          <textarea
            ...
            className="w-full border border-gray-400 rounded-md px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-600"
            rows={4}
            maxLength={maxLength}
            value={steps}
        ...
        <div className="mb-8">
          ...
          <label className="flex flex-col items-center justify-center border-2 border-dashed border-gray-400 rounded-xl p-12 cursor-pointer hover:bg-gray-50">
            <Image className="w-14 h-14 text-gray-500 mb-3" />
      ...
      <div className="mt-8 flex gap-6">
        <button
          onClick={goBack}
          className="flex-1 bg-white border border-gray-300 hover:bg-gray-100 text-gray-800 py-4 rounded-lg text-lg font-semibold"
        >
          ← Back
        </button>
        <button
          onClick={onSubmit}
          disabled={!confirm}
          className={`flex-1 py-4 rounded-lg text-lg font-semibold ${
            confirm
