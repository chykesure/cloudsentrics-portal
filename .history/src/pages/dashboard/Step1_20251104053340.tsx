            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <input
                ...
                className={`flex-1 px-4 py-3 border border-gray-300 rounded-b-md sm:rounded-r-md text-sm sm:text-lg ${
                  isDisabled ? "bg-gray-100 text-gray-400 cursor-not-allowed" : "bg-white text-gray-800"
                }`}
              />
            </div>
          </div>
    ...
    <div className="flex flex-col sm:flex-row justify-between gap-4 mt-10">
      ...
      <button
        ...
        className={`w-full sm:w-auto px-8 py-3 sm:px-10 sm:py-4 text-base sm:text-lg rounded-md ${
          !isStorageFormValid() ? "bg-gray-300 text-gray-500 cursor-not-allowed" : "bg-[#032352] text-white hover:bg-blue-700"
        }`}
      >
        Next →
      </button>
