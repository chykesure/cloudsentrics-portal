...
const Step1 = ({ goBack, jumpToStep, setFormData }: StepProps) => {
  ...
  const [awsAliases, setAwsAliases] = useState<{ [key: string]: string }>({});
  ...
  const isAwsFormValid = () => {
    if (!selectedOption || selectedOption !== "aws" || !selectedAwsCount) return false;

    if (selectedAwsCount <= 6) {
      for (let i = 0; i < selectedAwsCount; i++) {
        const label = String.fromCharCode(65 + i);
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-base sm:text-xl">
          ...
          <label className="flex items-start gap-3 cursor-pointer bg-gray-50 p-3 rounded-md hover:bg-gray-100">
            ...
            />
            <span className="text-gray-800 flex-1 leading-snug">Storage(s)</span>
          </label>
      ...
      {selectedOption === "aws" && (
        <div className="w-full px-2 sm:px-6 mb-12">
          <div className="flex flex-col sm:flex-row sm:items-center mb-8 gap-4 text-base sm:text-xl">
            <label className="font-medium">Number of AWS Account(s) Needed</label>
              ...
              return (
                <div key={label}>
                  ...
                  <div className="flex flex-col sm:flex-row">
                    <span className="inline-flex items-center px-4 py-2 sm:py-0 rounded-t-md sm:rounded-l-md border border-gray-300 bg-gray-100 text-gray-600 text-sm sm:text-lg">
                      cloudsentrics-aws-
                    </span>
                    <input
                      type="text"
            ...
            {["A", "B", "C", "D", "E", "F"].map((label, index) => {
              ...
              return (
                <div key={label}>
                  ...
                  <div className="flex flex-col sm:flex-row">
                    <span className="inline-flex items-center px-4 rounded-t-md sm:rounded-l-md border border-gray-300 bg-gray-100 text-gray-600 text-sm sm:text-lg">
