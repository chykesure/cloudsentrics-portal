            ...
            <div className="flex justify-center items-center gap-6 mb-6">
                {[1, 2, 3].map((num, idx) => (
                    <div key={num} className="flex items-center">
                        <div className="w-8 h-8 rounded-full border-2 border-orange-500 text-orange-500 flex justify-center items-center font-semibold">
                            {num}
                        </div>
                        {idx !== 2 && (
                            <div className="w-12 border-t-2 border-orange-500 mx-2"></div>
                        )}
                    </div>
                ))}
            </div>
