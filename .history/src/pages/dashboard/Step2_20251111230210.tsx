...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  // If CUSTOM, fetch backend storage info
  ...
  if (tierId === "custom") {
    ...
    if (!previousCustomRequest) {
      ...
      console.log("🚀 Sending CUSTOM first-timer payload:", payload);
    ...
    try {
      ...
      toast.success("Custom upgrade submitted successfully!");
      setSelectedTier("custom");
      setFormData((prev) => ({
        ...prev,
        selectedTier: "custom",
      ...
      Swal.fire({
        ...
        text: "An error occurred while submitting your custom upgrade request.",
        confirmButtonColor: "#032352",
      });
    } finally {
      setLoading(false);
  ...
  // -------------------------------
  // Normal Tier Flow (Standard/Business/Premium)
  // -------------------------------
