...
const Step3 = ({ goBack, jumpToStep }: StepProps) => {
  ...
  // ✅ Validation: ensure all rows are complete
  const isFormComplete = rows.every(
    (row) =>
      row.fullName.trim() !== "" &&
      row.email.trim() !== "" &&
      ...
      >
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:flex-wrap gap-4 text-lg md:text-xl">
            ...
            <label className="flex items-center space-x-2">
              <input type="checkbox" className="form-checkbox w-6 h-6" checked readOnly />
              <span>Storage(s)</span>
            </label>
              ...
              >
                ...
                <div className="md:col-span-4">
                  <input
                    ...
                    className="w-full px-3 py-2 md:px-4 md:py-2 border border-gray-300 rounded-md text-base md:text-lg"
                  />
                </div>
                ...
                <div className="md:col-span-2 relative" ref={dropdownRef}>
                  <button
                    ...
                    className="flex items-center justify-between w-full px-3 py-2 md:px-4 md:py-2 bg-[#032352] text-white text-base md:text-lg rounded-md"
                  >
                  ...
                  {openDropdown === index && (
                    <div className="absolute mt-1 w-full bg-white border border-gray-300 rounded-md shadow-lg z-10">
                      {accessOptions.map((option) => (
                        <div
                          key={option}
                          className="px-3 py-2 md:px-4 md:py-2 text-gray-700 hover:bg-blue-50 cursor-pointer"
                          onClick={() => {
        ...
        <div className="flex justify-between mt-12">
          ...
          <button
            ...
            className={`px-6 md:px-10 py-2 md:py-3 text-base md:text-xl rounded-md transition ${
              isFormComplete
