...
const ProfilePage = () => {
  ...
  // Fetch profile and latest request
  useEffect(() => {
  ...
  try {
    ...
    try {
      // Wrap request fetch in a try-catch to avoid breaking if 404
      ...
      if (latestRequest) {
        tier = latestRequest.selectedTier;
        storage = latestRequest.selectedStorageCount.toString();
      }
    } catch (err) {
