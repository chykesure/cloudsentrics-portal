  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = cleanObject({
        ...
        tierTitle: formData.selectedTier === "custom" ? "CUSTOM" : undefined,
        tierStorage:
          formData.selectedTier === "custom"
            ? `${formData.customAmount} ${formData.customUnit}`
            : tierMap[formData.selectedTier]?.storage
