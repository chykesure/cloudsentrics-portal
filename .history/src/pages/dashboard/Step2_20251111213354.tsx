...
const handleSelectTier = async (tierId: string) => {
  ...
  try {
    ...
    const confirmUpgrade = await Swal.fire({
      ...
      html: `You are currently on <b>${currentTierInfo?.title || "None"}</b> (${
        currentTierInfo?.storage || "0GB"
      }) and about to upgrade to <b>${selectedTierInfo.title}</b> (${
        selectedTierInfo.storage
