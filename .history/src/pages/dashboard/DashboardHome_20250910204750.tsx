                    ...
                    {issues.map((item, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                transition={{ delay: idx * 0.2 }}
                                whileHover={{ scale: 1.04 }}
                                className={`${item.color} p-10 min-h-[200px] rounded-2xl shadow-lg flex items-center gap-8 hover:shadow-2xl transition`}
                            >
                                {/* Bigger icon inside translucent background */}
                                <div className="p-6 rounded-full bg-white/30 flex items-center justify-center">
                                    <Icon className="h-14 w-14 text-white" />
                                </div>

                                {/* Bigger numbers + labels */}
                                <div>
                                    <h3 className="text-5xl font-extrabold text-white">{count}</h3>
                                    <p className="text-lg mt-2 text-white opacity-90">{item.label}</p>
                                </div>
                            </motion.div>
                        );
                    })}
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="pl-8 pr-3 py-1.5 text-sm border rounded-lg focus:ring-[#032352] focus:border-[#032352] shadow-sm"
          />
        </div>
        ...
        <tbody>
          {requests.map((row, idx) => (
            ...
            >
              ...
              <td className="py-3 px-3">
                <button className="text-[#032352] text-xs font-semibold hover:underline">
                  View
                </button>
              </td>
            </motion.tr>
