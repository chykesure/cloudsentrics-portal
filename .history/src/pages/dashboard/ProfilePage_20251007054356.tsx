...
import defaultAvatar from "../../../src/assets/avatar-placeholder.png";
        ...
        >
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="relative">
              ...
              />
              {isEditing && (
                <label className="absolute bottom-0 right-0 bg-[#032352] text-white px-2 py-1 text-xs rounded-lg cursor-pointer shadow">
                  Upload
