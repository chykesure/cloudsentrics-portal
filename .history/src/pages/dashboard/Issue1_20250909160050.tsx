            ...
            <div className="flex-1 w-full p-10 bg-white shadow-md">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex justify-center items-center min-h-screen bg-gray-50">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl w-full p-6 bg-white shadow-lg rounded-2xl">
                            {/* Account ID */}
                            <div>
                            ...
                            {/* Storage / Bucket Name */}
                            <div>
                                <label className="block text-sm font-medium mb-2">Storage / Bucket Name</label>
                                <input
                                    type="text"
