  ...
  return (
    ...
    >
      <div className="flex-1 w-full p-10 bg-white shadow-md">
        {/* Instruction */}
        <p className="mb-8 text-gray-700 text-base leading-relaxed max-w-5xl">
        ...
        <div className="mb-12">
          <h3 className="bg-orange-100 py-3 px-5 text-blue-900 font-semibold text-sm rounded-md mb-6 uppercase tracking-wide">
            Issue Information
          </h3>
