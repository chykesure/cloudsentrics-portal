...
const DashboardHome = () => {
  ...
  const stats = [
    { title: "Profile", icon: User, color: "from-[#032352] to-[#054080]" },
    { title: "Request Portal", icon: FileText, color: "from-[#033a66] to-[#04509c]" },
    { title: "Report Issue", icon: Bell, color: "from-[#032b52] to-[#033c7a]" },
  ];

  const actionsColors = [
    "from-[#054080] to-[#0656aa]",
    "from-[#033c7a] to-[#04509c]",
    "from-[#032b52] to-[#033c7a]"
  ];
