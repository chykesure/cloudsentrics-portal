...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  const handleSelectTier = async (tierId: string) => {
    ...
    if (tierId === "custom") {
      ...
      // Helper to convert any storage string to GB
      ...
      // Determine current and selected storage in GB
      const currentStorageGB = parseStorageToGB(currentTierInfo?.storage || "0GB");
      const selectedStorageGB = parseStorageToGB(selectedTierInfo?.storage || "0GB");
