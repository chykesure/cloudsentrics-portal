...
const Issue1 = ({ goNext }: StepProps) => {
  ...
  const inputClass =
    "form-control w-full border border-gray-300 rounded-lg px-4 py-3 text-base focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition";
  ...
  return (
    ...
    >
      {/* Card Container */}
      <div className="w-full max-w-6xl bg-white shadow-lg rounded-2xl p-10">
        {/* Instruction */}
        ...
        <div className="mb-12">
          <h3 className="bg-orange-100 py-3 px-5 text-blue-900 font-semibold text-lg rounded-md mb-6 uppercase tracking-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div>
              <label className="block text-base font-medium mb-2">Company / Organization</label>
              <input
                type="text"
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Account ID */}
            <div>
              <label className="block text-base font-medium mb-2">Account ID</label>
              <input
                type="text"
            ...
            {/* Storage / Bucket Name */}
            <div>
              <label className="block text-base font-medium mb-2">Storage / Bucket Name</label>
              <input
                type="text"
