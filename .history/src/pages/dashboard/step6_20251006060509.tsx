...
const Step6 = ({ goBack, formData }: StepProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ✅ Add extra aliases from bucket note
      ...
      // ✅ Atlassian Document Format (ADF) for Jira description
      const descriptionADF = {
        ...
        content: [
          ...
          // 🆕 Include CHANGE REQUEST details
          {
            type: "paragraph",
          ...
          },
          {
            ...
            content: [
              {
                type: "text",
                text: `Existing Account ID: ${formData.existingAccountId || "N/A"
                  }`,
              },
            ],
          },
          {
            ...
            content: [
              {
                type: "text",
                text: `Existing Storage Name: ${formData.existingStorageName || "N/A"
                  }`,
              },
            ],
          },
          ...(formData.changesRequested || []).map((change: string) => ({
            type: "paragraph",
          ...
          })),
          {
            ...
            content: [
              {
                type: "text",
                text: `Additional Details: ${formData.details || "None"}`,
              },
            ],
          },
      ...
      const payload = {
        ...
        reporterEmail,
        selectedTier: formData.selectedTier || "standard", // 🆕 FIXED
        awsAccounts,
        acknowledgements,
