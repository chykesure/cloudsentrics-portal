...
import Step6 from "../dashboard/step6"; // 👈 NEW
...
const RequestWizard = () => {
  ...
  const goNext = () => {
    if (currentStep < 6) setCurrentStep((prev) => prev + 1); // 👈 updated max to 6
  };
  ...
  <Step1 goNext={goNext} goBack={goBack} jumpToStep={jumpToStep} />  // ✅ add it here
) : currentStep === 2 ? (
