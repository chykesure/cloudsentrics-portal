...
const Step6 = ({ goBack, onSubmit, formData }: StepProps) => {
  ...
  // Get reporter email from localStorage
  useEffect(() => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Include extra aliases from bucketNote if >6
      ...
      // Compute total AWS accounts requested
      ...
      const payload = {
        ...
        awsAccounts,
        acknowledgements,
        selectedStorageCount: formData.selectedStorageCount, // ✅ add this
      };
