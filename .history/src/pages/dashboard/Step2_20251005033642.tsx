...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  // ✅ Update formData whenever a tier is selected
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-10">
          {tiers.map((tier) => (
            <div
              key={tier.id}
              className={`border rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-md flex flex-col justify-between transition ${selectedTier === tier.id
            ...
            >
              ...
              <button
                ...
                className={`mt-6 sm:mt-8 py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg text-base sm:text-xl font-semibold flex items-center justify-center gap-2 transition ${selectedTier === tier.id
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between gap-4 mt-8 sm:mt-12">
          ...
          <button
            ...
            className={`w-full sm:w-auto px-6 sm:px-10 py-2.5 sm:py-3 rounded-md text-base sm:text-xl font-semibold ${selectedTier
