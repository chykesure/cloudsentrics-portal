    ...
    >
      ...
      {selectedOption === "aws" && (
        <div className="w-full px-2 sm:px-6 mb-12">
          ...
          <p className="text-sm sm:text-base mb-4">Note: Provide the Organization Name / Department using the account</p>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 mt-10">
            ...
            <button
              ...
              disabled={
                ...
                (selectedStorageCount > 6 &&
                  (["A", "B", "C", "D", "E", "F"].some((l) => !awsAliases[l]?.trim()) || !bucketNote.trim()))
              }
