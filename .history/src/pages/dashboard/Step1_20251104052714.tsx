    ...
    >
      ...
      {selectedOption === "aws" && (
        <div className="w-full px-2 sm:px-6 mb-12">
          ...
          {/* Dynamic alias inputs */}
          {selectedStorageCount > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {Array.from(
                { length: Math.min(selectedStorageCount, 6) },
          ...
          {/* Extra alias textarea (only active if more than 6) */}
          {selectedStorageCount > 6 && (
            <div className="mb-10">
              ...
              <textarea
                ...
                className="w-full p-4 border border-gray-300 rounded-md text-sm sm:text-lg resize-none bg-white text-gray-800 focus:ring-2 focus:ring-blue-700 outline-none"
                maxLength={maxLength}
              ></textarea>
