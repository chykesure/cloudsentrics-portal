...
const Step1 = ({ goBack, jumpToStep, setFormData }: StepProps) => {
  ...
  const [selectedAwsCount, setSelectedAwsCount] = useState<number | null>(null);
        ...
        <div className="w-full px-2 sm:px-6 mb-12">
                  ...
                  <input
                    ...
                    onChange={() => {
                      ...
                      setFormData((prev) => ({
                        ...prev,
                        selectedAwsCount: n,
                        requestType: "aws", // ✅ always set AWS
                        selectedStorageCount: null, // 🧹 clear storage
                      }));
                    }}
            ...
            <div className="flex flex-col w-full sm:w-64">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setFormData((prev) => ({
                    ...prev,
                    selectedAwsCount: count,
                    requestType: "aws", // ✅ force AWS
                    selectedStorageCount: null,
                  }));
                }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            {["A", "B", "C", "D", "E", "F"].map((label, index) => {
              const isDisabled =
                selectedAwsCount !== null && selectedAwsCount < index + 1;
                      ...
                      onChange={(e) => {
                        ...
                        setAwsAliases((prev) => {
                          ...
                          setFormData((prevData) => ({
                            ...prevData,
                            awsAliases: updated,
                            requestType: "aws", // keep this consistent
                          }));
                          return updated;
                        });
                      }}
                      disabled={isDisabled}
                      className={`flex-1 px-4 py-3 border border-gray-300 rounded-b-md sm:rounded-r-md text-sm sm:text-lg ${isDisabled
          ...
          {/* Extra alias textarea (for >6 accounts) */}
          <div className="mb-10">
            ...
            <textarea
              ...
              className={`w-full p-4 border border-gray-300 rounded-md text-sm sm:text-lg resize-none ${selectedAwsCount && selectedAwsCount <= 6
                ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                : "bg-white text-gray-800"
                }`}
              maxLength={maxLength}
              readOnly={selectedAwsCount !== null && selectedAwsCount <= 6}
            ></textarea>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 mt-10">
            ...
            <button
              ...
              className={`w-full sm:w-auto px-6 sm:px-10 py-3 sm:py-4 text-base sm:text-lg rounded-md ${!selectedAwsCount ||
                (selectedAwsCount <= 6 &&
                  Array.from({ length: selectedAwsCount }).some(
                    (_, i) => !awsAliases[String.fromCharCode(65 + i)]?.trim()
                  )) ||
      ...
      {selectedOption === "storage" && (
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            {["A", "B", "C", "D", "E", "F"].map((label, index) => {
              const isDisabled =
                selectedStorageCount !== null && selectedStorageCount < index + 1;
              return (
                <div key={label}>
                  <label className="text-base sm:text-xl font-medium text-gray-700 mb-2 block">
                    {label}
          ...
          <div className="mb-10">
            ...
            <textarea
              ...
              className={`w-full p-4 border border-gray-300 rounded-md text-sm sm:text-lg resize-none ${selectedStorageCount && selectedStorageCount <= 6
                ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                : "bg-white text-gray-800"
                }`}
              maxLength={maxLength}
              readOnly={selectedStorageCount !== null && selectedStorageCount <= 6}
            ></textarea>
            <div className="text-right text-sm sm:text-md text-gray-500 mt-1">
              {bucketNote.length}/{maxLength}
            </div>
            ...
            <button
              onClick={() => {
                if (selectedOption === "storage") {
                  confirmBeforeNext(() => jumpToStep?.(2));
                }
              }}
