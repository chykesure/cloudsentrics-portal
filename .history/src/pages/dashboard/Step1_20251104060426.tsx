    ...
    >
      ...
      {selectedOption === "aws" && (
        <div className="w-full px-2 sm:px-6 mb-12">
          ...
          {selectedStorageCount !== null && selectedStorageCount > 0 && (
          ...
          {selectedStorageCount !== null && selectedStorageCount > 6 && (
            <div className="mb-10">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 mt-10">
            ...
            <button
              ...
              disabled={!selectedStorageCount || selectedStorageCount <= 0}
              className={`w-full sm:w-auto px-6 sm:px-10 py-3 sm:py-4 text-base sm:text-lg rounded-md ${!selectedStorageCount
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            {["A", "B", "C", "D", "E", "F"].map((label, idx) => {
              const isDisabled =
                !selectedStorageCount || selectedStorageCount < idx + 1;
              return (
                <div key={label}>
                  <label className="text-base sm:text-xl font-medium text-gray-700 mb-2 block">
                    {label}
