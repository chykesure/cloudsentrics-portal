...
const DashboardHome = () => {
  ...
  className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative"
>
  {/* Text */}
  <div>
  ...
  {avatarUrl && (
    <img
      src={avatarUrl}
      alt="User Avatar"
      className="w-48 h-48 object-cover rounded-full border-4 border-white absolute md:relative md:right-0 md:top-0 top-1/2 right-6 transform -translate-y-1/2 shadow-xl"
    />
  )}
</motion.div>
