...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  const hideContent = location.pathname === "/dashboard/upgrade-tier";

  if (hideContent) return null; // hides only this block
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-3 sm:px-6 py-6 sm:py-10">
      ...
      >
        {/* Request Type */}
        <div className={`mb-6 sm:mb-8 ${hideContent ? "hidden" : ""}`}>
