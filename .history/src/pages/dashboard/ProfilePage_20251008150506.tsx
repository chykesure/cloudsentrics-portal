  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        ...
        // If backend returns avatar, store it
        if (data.avatar) {
      ...
      <div className="max-w-7xl mx-auto -mt-14 sm:-mt-20 px-4 sm:px-8 mb-16">
        <div className="flex flex-col md:flex-row justify-center items-start gap-6 md:gap-10">
          ...
          <motion.div
            ...
            className="flex-1 w-full max-w-md bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-6 sm:p-10 border border-gray-200 text-center mx-auto"
          >
          ...
          <motion.div
            ...
            className="flex-1 w-full max-w-md bg-white/80 backdrop-blur-lg rounded-2xl shadow-lg p-6 sm:p-10 border border-gray-200 mx-auto"
          >
