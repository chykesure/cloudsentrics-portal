    ...
    >
      ...
      {selectedOption === "aws" && (
        <div className="mb-12">
          ...
          <p>Note: Provide the Organization Name / Department using the account </p>
          {/* Bucket Names */}
          ...
          <div className="mb-10">
            ...
            <textarea
              ...
              placeholder="Starting with cloudsentrics-[organization name-storage purpose-customer ID]."
            ...
            <button
              onClick={() => {
                if (selectedOption === "aws") {
                  jumpToStep?.(6); // 👈 go straight to Step 5
                }
              }}
