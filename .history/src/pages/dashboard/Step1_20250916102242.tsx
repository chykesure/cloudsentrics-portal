...
// ✅ Small reusable Radio/Checkbox UI
const RadioCheck = ({
  label,
  selected,
  onClick,
  ...
  <label
    className={`flex items-center gap-2 cursor-pointer px-3 py-1 rounded-md border ${selected ? "bg-blue-600 text-white border-blue-600" : "border-gray-400"
      }`}
    onClick={onClick}
  >
      ...
      {selectedOption === "change" && (
        ...
        >
          ...
          <p className="text-lg text-gray-700 mb-8 leading-relaxed">
            Note: All Cloud Sentrics Storage comes by default with versioning and
            SSE-S3 encryption enabled. Additional settings may incur extra charges and
            ...
            <div className="flex gap-6 mb-4">
              <label className="flex items-center gap-3 cursor-pointer text-lg">
                <input
                  ...
                  className="w-6 h-6 border-2 border-gray-400 rounded-md appearance-none checked:bg-[#032352] checked:border-[#032352] cursor-pointer"
                />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            {/* Retention + Transition (show only if Lifecycle = Yes) */}
            {lifecycle === "Yes" && (
              <div className="p-6 bg-white shadow-md rounded-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">
                  Retention Duration:
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-3 text-lg">
                    <input
                      ...
                      className="w-6 h-6 border-2 border-gray-400 rounded-md cursor-pointer checked:bg-[#032352] checked:border-[#032352]"
                    />
