...
const Issue3 = ({ goBack, formData, setFormData, onSubmit }: StepProps & { onSubmit: () => Promise<void> }) => {
  ...
  const handleSubmitClick = async () => {
    ...
    setSubmitting(true);
    try {
      await onSubmit(); // Call the ReportIssue submit handler
    } catch (err) {
        ...
        <div>
          ...
          <div className="flex items-start mb-10">
            <input
              ...
              onChange={() => setFormData({ ...formData, confirm: !formData.confirm })}
