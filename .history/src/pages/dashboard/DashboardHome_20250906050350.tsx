          ...
          {stats.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white p-8 min-h-[150px] rounded-2xl shadow-md flex items-center gap-6 hover:shadow-xl transition"
              >
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-base mt-1">{item.label}</p>
                </div>
              </motion.div>
            );
          })}
