...
const DashboardHome = () => {
  ...
  // Load user and avatar from localStorage
  useEffect(() => {
  ...
  const actions: QuickAction[] = [
    { title: "Request Portal", description: "Submit or view requests", icon: FileText },
    { title: "Report Issue", description: "Report any issues", icon: Bell },
    { title: "Profile", description: "Update your profile info", icon: User },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 p-6 sm:p-10 space-y-10">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex items-center gap-4">
          <img
            src={profileImage || defaultAvatarUrl}
            alt="User"
