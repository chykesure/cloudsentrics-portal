                ...
                {Array.from(
                  ...
                  <div key={label}>
                    ...
                    <div className="flex flex-col sm:flex-row w-full">
                      <span className="inline-flex items-center px-4 py-2 sm:py-0 rounded-t-md sm:rounded-l-md sm:rounded-t-none border border-b-0 sm:border-r-0 border-gray-300 bg-gray-100 text-gray-600 text-sm sm:text-lg">
                        cloudsentrics-aws-
                      </span>
                      <input
                        type="text"
                        placeholder="Organization-Department-Purpose"
                        value={awsAliases[label] || ""}
                        onChange={(e) => {
                          const val = e.target.value;
                          setAwsAliases((prev) => {
                        ...
                        className="flex-1 px-4 py-3 border border-gray-300 rounded-b-md sm:rounded-r-md text-sm sm:text-lg w-full"
                      />
                    </div>
                  </div>
                ))}
