      ...
      <div className="p-6 bg-white shadow-md rounded-lg mb-8">
        ...
        {fileSharing === "Yes" && (
          <div className="ml-4 space-y-4">
            ...
            {[
              ...
              },
              {
                ...
                label: (
                  <>
                    ...
                    File delivered to recipient's email, but requires OTP sent to their
                    WhatsApp before download.
                  </>
                ),
              },
              {
              ...
              },
              {
                ...
                label: (
                  <>
                    ...
                    File securely delivered to both recipient's WhatsApp Number and Email
                    address.
                  </>
                ),
              },
              ...
              <label key={value} className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  name="deliveryMethod"
                  value={value}
                  checked={fileOptions.includes(value)} // ✅ multiple selection
                  onChange={() =>
                    setFileOptions((prev) =>
                      prev.includes(value)
                        ? prev.filter((v) => v !== value) // remove if exists
                        : [...prev, value] // add if not
                    )
                  }
                  className="h-5 w-5 text-[#032352] focus:ring-[#032352]"
                />
            ...
            {/* ✅ OTP Subscription Plans - shown per selected option */}
            {fileOptions.map(
              (opt) =>
                    ...
                    <div className="flex flex-wrap gap-4">
                      {["500", "1000", "1500"].map((plan) => (
                        ...
                        >
                          <input
                            type="radio"
                            name={`otpPlan-${opt}`} // ✅ separate for each option
                            value={plan}
                            checked={otpPlan[opt] === plan}
                            onChange={() => {
                              setOtpPlan({ ...otpPlan, [opt]: plan });
                              setCustomOtp({ ...customOtp, [opt]: "" }); // clear custom input
                            }}
                            className="h-5 w-5 text-[#032352] focus:ring-[#032352]"
                          />
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onFocus={() => setOtpPlan({ ...otpPlan, [opt]: "custom" })}
