...
const Step1 = ({ goBack, jumpToStep }: StepProps) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white min-h-screen w-full px-4 sm:px-6 lg:px-8 py-10"
    ...
    >
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-base sm:text-xl">
          {/* AWS */}
          <label className="flex items-center gap-3 cursor-pointer bg-gray-50 p-3 rounded-md hover:bg-gray-100">
            <input
              type="checkbox"
