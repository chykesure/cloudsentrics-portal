...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  // --- Helper: parse storage string (e.g., "600GB", "1TB") to GB
  ...
  if (tierId === "custom") {
    ...
    // --- Downgrade prevention: only if currentTierInfo exists
    if (currentTierInfo) {
    ...
    // --- Save custom tier & enable Next button
