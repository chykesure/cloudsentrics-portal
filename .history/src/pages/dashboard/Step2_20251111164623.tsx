...
const Step2 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  // Use null for first-time instead of empty strings
  ...
  timestamp: new Date().toISOString(),
        ...
        toast.success(res.data.message || (isFirstTime ? "Storage setup successful!" : "Upgrade successful!"));
        await Swal.fire({
          icon: "success",
        ...
        if (isFirstTime) return; // No reload for first-time selection
