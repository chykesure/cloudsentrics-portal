...
const Step4 = ({ goBack, jumpToStep, formData, setFormData }: StepProps) => {
  ...
  // ✅ Prefill Data from formData (when revisiting)
  useEffect(() => {
               ...
               const options = [
  {
    ...
    label: (
      <span>
        <strong>Email Only</strong>: Delivered via email.
      </span>
    ),
  },
  {
    ...
    label: (
      <span>
        <strong>Email + OTP</strong>: Delivered via email and requires OTP on WhatsApp.
      </span>
    ),
  },
  {
    ...
    label: (
      <span>
        <strong>WhatsApp Only</strong>: Delivered via WhatsApp.
      </span>
    ),
  },
  {
    ...
    label: (
      <span>
        <strong>Both WhatsApp & Email delivery</strong>: Delivered via WhatsApp and Email.
      </span>
    ),
  },
];
