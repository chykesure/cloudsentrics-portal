  ...
  const announcements: Announcement[] = [
    {
      ...
      message: "Your issue report has been successfully submitted and is being reviewed.",
      date: "2025-10-08",
    },
    {
      id: 2,
      title: "Request Received",
      message: "Your service request has been received. We will get back to you shortly.",
      date: "2025-10-07",
    },
    {
      id: 3,
      title: "Report Updated",
      message: "The status of your reported issue has been updated. Check your dashboard for details.",
      date: "2025-10-06",
    },
    {
      id: 4,
      title: "Request Approved",
      message: "Your request has been approved. You can now access the requested feature.",
      date: "2025-10-05",
    },
  ];
