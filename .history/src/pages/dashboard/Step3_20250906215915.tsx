...
const Step3 = ({ goNext, goBack }: StepProps) => {
  ...
  return (
    ...
    >
      ...
      {/* WHO REQUIRE ACCESS */}
      <div className="mb-6">
        <div className="bg-blue-100 px-4 py-2 rounded-t-md text-lg font-semibold text-blue-900 flex justify-between items-center">
        ...
        {/* User Inputs */}
        <div className="bg-white border border-t-0 rounded-b-md divide-y">
          {users.map((user, index) => (
            <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4">
              ...
              <div>
                ...
                <select
                  value={user.access}
                  onChange={(e) => handleUserChange(index, "access", e.target.value)}
