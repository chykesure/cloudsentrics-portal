        ...
        <div className="w-full px-2 sm:px-6 mb-12">
            ...
            <div className="flex flex-wrap gap-4">
              {[1, 2, 3, 4, 5].map((n) => (
                <label key={n} className="flex items-center relative cursor-pointer">
                  ...
                  />
                  <span
                    className={`pointer-events-none absolute left-1 top-0.5 w-5 h-5 flex items-center justify-center text-white ${selectedStorageCount === n ? "opacity-100" : "opacity-0"} transition-opacity duration-200`}
                  >
                    ✓
                  </span>
          ...
          {selectedStorageCount > 0 && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {Array.from({ length: selectedStorageCount > 6 ? 6 : selectedStorageCount }).map((_, idx) => {
