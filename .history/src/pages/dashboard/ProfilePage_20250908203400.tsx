            ...
            {Object.keys(form).map((key) => (
              <div key={key} className="flex flex-col">
                ...
                <input
                  ...
                  className="form-control w-full rounded-lg border border-gray-300 bg-white px-4 py-2 text-gray-800 shadow-sm focus:border-[#032352] focus:ring-2 focus:ring-[#032352] focus:outline-none transition"
                />
              </div>
            ))}
          </div>
