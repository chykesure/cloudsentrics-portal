  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        content: [
          ...
          },
          {
            ...
            content: [
              {
                type: "text",
                text: `Existing Account ID: ${
                  formData.existingAccountId || "N/A"
                }`,
              },
            ],
          },
          {
            ...
            content: [
              {
                type: "text",
                text: `Existing Storage Name: ${
                  formData.existingStorageName || "N/A"
                }`,
              },
            ],
          },
      ...
      const payload = {
        ...
        // 🆕 Include Change Section Fields in the payload
