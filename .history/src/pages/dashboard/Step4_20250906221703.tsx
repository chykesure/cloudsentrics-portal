      ...
      <div className="mb-8">
        ...
        <div className="px-4 py-6">
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-md text-lg bg-gray-50 focus:ring-2 focus:ring-blue-400"
          />
        </div>
      </div>
      ...
      <div className="mb-10">
        ...
        <div className="px-4 py-6">
          <textarea
            ...
            className="w-full p-4 rounded-md text-lg resize-none bg-gray-50 focus:ring-2 focus:ring-blue-400"
            rows={5}
          />
        </div>
      </div>
