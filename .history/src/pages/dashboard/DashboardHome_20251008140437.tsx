...
const DashboardHome = () => {
  ...
  // Hardcoded announcements and actions (optional, can also be dynamic later)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 p-6 sm:p-10 space-y-10">
      <div className="relative">
        <motion.div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
        ...
        {avatarUrl && (
          <img
            src={avatarUrl}
            alt="User Avatar"
            className="w-48 h-48 object-cover rounded-full border-4 border-white absolute top-1/2 right-6 transform -translate-y-1/2 shadow-xl"
          />
        )}
      </div>
