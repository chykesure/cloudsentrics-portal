...
const DashboardHome = () => {
  ...
  const requests = [
    { type: "Additional AWS Accounts", date: "Aug 15, 2025", time: "10:34am", status: "Pending" },
    { type: "Additional S3 Buckets", date: "Aug 15, 2025", time: "09:20am", status: "Approved" },
    { type: "IAM Policy Update", date: "Aug 14, 2025", time: "03:45pm", status: "Approved" },
    { type: "Database Backup", date: "Aug 13, 2025", time: "11:15am", status: "Pending" },
    { type: "VPC Peering", date: "Aug 12, 2025", time: "04:00pm", status: "Approved" },
  ];
