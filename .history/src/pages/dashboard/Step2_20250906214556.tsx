    ...
    >
      ...
      <div className="mb-8 text-lg">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <input
            ...
            className="px-4 py-2 border border-gray-300 rounded-md text-lg w-72"
            onChange={(e) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        {["A", "B", "C", "D", "E", "F"].map((label) => (
          <div key={label} className="flex items-start gap-2">
            <div className="pt-3 text-lg font-medium text-gray-700 w-4">{label}</div>
            <div className="flex-1">
              <label className="sr-only">Bucket Name {label}</label>
              <div className="flex">
                ...
                <input
                  type="text"
                  placeholder="OrganizationName-StoragePurpose-CustomerID"
      ...
      <div className="mb-10">
        ...
        <textarea
          ...
          className="w-full p-4 border border-gray-300 rounded-md text-lg resize-none text-gray-800 placeholder-gray-400"
          maxLength={maxLength}
        />
      ...
      <div className="flex justify-between mt-10">
        ...
        <button
          onClick={goNext}
          className="px-8 py-3 bg-blue-600 text-white text-lg rounded-md hover:bg-blue-700"
        >
          Next →
        </button>
      </div>
