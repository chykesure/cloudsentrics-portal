...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-100 to-gray-50">
      ...
      {/* Profile Card */}
      <div className="max-w-4xl mx-auto -mt-14 sm:-mt-20 px-4 sm:px-8">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10 border border-gray-200 text-center"
        >
          {/* Avatar Upload */}
