        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
            {["A", "B", "C", "D", "E", "F"].map((label, index) => {
              const isReadOnly = index + 1 > selectedStorageCount; // disable beyond entered number
              return (
                <div key={label}>
                  ...
                  <div className="flex flex-col sm:flex-row">
                    ...
                    <input
                      ...
                      readOnly={isReadOnly}
                      className={`flex-1 px-4 py-3 border border-gray-300 rounded-b-md sm:rounded-r-md text-sm sm:text-lg w-full transition-all ${isReadOnly
          ...
          <div className="mb-10">
            ...
            <textarea
              ...
              readOnly={selectedStorageCount <= 6}
              className={`w-full p-4 border border-gray-300 rounded-md text-sm sm:text-lg resize-none transition-all ${selectedStorageCount <= 6
                  ? "bg-gray-100 cursor-not-allowed opacity-70"
                  : "bg-white"
                }`}
              maxLength={maxLength}
