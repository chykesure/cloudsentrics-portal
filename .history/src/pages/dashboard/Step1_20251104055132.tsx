  ...
  <div className="w-full px-2 sm:px-6 mb-12">
    ...
    {selectedStorageCount > 0 && (
      <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
          {Array.from({ length: Math.min(selectedStorageCount, 6) }).map(
            (_, idx) => {
              ...
              return (
                <div key={label}>
                  ...
                  <div className="flex flex-col sm:flex-row">
                    <span className="inline-flex items-center px-4 py-2 sm:py-0 rounded-t-md sm:rounded-l-md sm:rounded-t-none border border-gray-300 bg-gray-100 text-gray-600 text-sm sm:text-lg">
                      cloudsentrics-aws-
                    </span>
                    <input
                      type="text"
    ...
    <div className="flex flex-col sm:flex-row justify-between gap-4 mt-10">
      ...
      <button
        ...
        disabled={
          ...
          (selectedStorageCount <= 6 &&
            Array.from({ length: selectedStorageCount }).some(
              (_, i) =>
                !awsAliases[String.fromCharCode(65 + i)]?.trim()
            )) ||
          (selectedStorageCount > 6 &&
            (["A", "B", "C", "D", "E", "F"].some(
              (l) => !awsAliases[l]?.trim()
        ...
        className={`w-full sm:w-auto px-6 sm:px-10 py-3 sm:py-4 text-base sm:text-lg rounded-md ${!selectedOption || selectedOption !== "aws" || !selectedStorageCount
          ...
          (_, idx) => {
            ...
            return (
              <div key={label}>
                ...
                <div className="flex flex-col sm:flex-row">
                  <span className="inline-flex items-center px-4 rounded-t-md sm:rounded-l-md sm:rounded-t-none border border-gray-300 bg-gray-100 text-gray-600 text-sm sm:text-lg">
