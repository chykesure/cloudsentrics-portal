  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        ...
        const profile = data.data; // ✅ use nested `data`
        setForm({
          name: profile.name || "",
          ...
          companyName: profile.companyName || "", // ✅ added
        });



        // Only use backend avatar if no avatar is in localStorage
        if (!storedAvatar && data.avatar) {
