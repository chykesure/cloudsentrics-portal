...
const ProfilePage = () => {
  ...
  const [avatarChanged, setAvatarChanged] = useState(false); // ✅ Track avatar change
  ...
  const handleAvatarChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = () => {
      ...
      setAvatar(base64);
      setAvatarChanged(true); // ✅ Enable update button
    };
  ...
  const handleProfileUpdate = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setAvatarChanged(false); // ✅ Disable button again
      } else {
          ...
          >
            ...
            <div className="mt-8 flex justify-center">
              <button
                ...
                className={`px-6 py-2 rounded-lg shadow font-semibold text-base transition-all duration-200 ${
                  avatarChanged
